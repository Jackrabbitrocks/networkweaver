...
<?php while (have_posts()) : the_post(); ?>
    <div id="main-wrap" class="cat-<?php $category = get_the_category(); $category_slug = $category[0]->slug; echo($category_slug); ?>">
        <div id="header-wrap" style="<?php echo $header_image_bg; ?>">
            <header class="entry-header">
                
                <div class="entry-header-inner" style="background-image:url(<?php echo get_the_post_thumbnail_url(get_the_ID(),'full'); ?>);">
                    <div class="title-breadcrumb-wrap">
                        <?php the_title('<h1 class="entry-title">', '</h1>'); ?>
                    </div>
                </div>
                <div class="entry-header-byline">
